import { defaultAction, managePlantList, fetchPipelinesDetails, getSegmentData, getAlarmChart, getAttributes } from '../actions';
...
describe('Dashboard actions', () => {
  ...
  describe('GET_SEGMENT_DATA', () => {
    it('has a type of GET_SEGMENT_DATA', () => {
      ...
      expect(getSegmentData("demo","demo","demo")).toEqual(expected);
    });
  });
  ...
  describe('GET_CHART_DATA', () => {
    it('has a type of GET_CHART_DATA', () => {
      const expected = {
        ...
        plantId: "demo", 
        distance: "demo",
        selectedAttribute: "demo"
      };
      expect(getAlarmChart("demo","demo","demo","demo")).toEqual(expected);
    });
  });
